 ...
 *
 * Servo 1 is intentionally untouched. Servo 2 + 3 act as a flap pair:
...
void setup() {
  ...
  Serial.print("INIT: servo2="); Serial.print(s2Angle);
  Serial.print(" servo3="); Serial.print(s3Angle);
  Serial.print(" servo4="); Serial.println(s4Angle);
  Serial.println("CMD: B:<deg> C:<deg> D:<deg> SWEEP2 SWEEP3 SWEEP4 PULSE3 PULSE4 STATUS");
}
...
void loop() {
  ...
  if      (cmd.startsWith("B:")) moveServo(flap2, s2Angle, cmd.substring(2).toInt(), '2');
    ...
    Serial.print("STATUS: servo2="); Serial.print(s2Angle);
    Serial.print(" servo3=");        Serial.print(s3Angle);
    Serial.print(" servo4=");        Serial.println(s4Angle);
  } else {
